...
export default function HomePage() {
  ...
  const getStatusMessage = (measurement: any) => {
    if (!measurement)
      return { message: "No data available", status: "neutral" };
        ...
        return (
          <div className="flex flex-col gap-4 p-4">
                ...
                {latestMeasurement ? (
                  ...
                  <div className="flex flex-col items-center gap-4 py-6">
                    <p className="text-white text-center">
                      No measurements yet. Create your first measurement.
                    </p>
                    <Button
            ...
            {latestMeasurement && (
              <Button
                variant="outline"
                className="border-red-600 bg-[#0000] text-red-500 hover:bg-red-900/20 hover:text-red-400"
